...
namespace SzyBlog.ObjectExtending
{
    public static class SzyBlogDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the SzyBlogEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
